...
class SignUpForm(FlaskForm):
    ...
    email = StringField('Email', validators=[DataRequired(message="Email is required"), user_exists, Email("Email is required"), Length(max=30, message="Email cannot exceed 30 characters!")])
