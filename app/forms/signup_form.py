...
class SignUpForm(FlaskForm):
    ...
    email = StringField('Email', validators=[DataRequired(message="Email is required"), user_exists, Email("Email address format invalid"), Length(max=30, message="Email cannot exceed 30 characters!")])
